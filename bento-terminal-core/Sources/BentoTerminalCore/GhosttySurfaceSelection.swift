...
@MainActor
public enum GhosttySel {
    /// Select the word under `px` (emulates a double-click). Returns whether a
    /// selection now exists.
    @discardableResult
    public static func selectWord(_ surface: ghostty_surface_t, px: (x: Double, y: Double)) -> Bool {
    ...
    @discardableResult
    public static func begin(_ surface: ghostty_surface_t, px: (x: Double, y: Double),
    ...
    public static func extend(_ surface: ghostty_surface_t, px: (x: Double, y: Double),
    ...
    public static func end(_ surface: ghostty_surface_t, mods: ghostty_input_mods_e = GHOSTTY_MODS_NONE) {
        ghostty_surface_mouse_button(surface, GHOSTTY_MOUSE_RELEASE, GHOSTTY_MOUSE_LEFT, mods)
        ghostty_surface_refresh(surface)
    }

    public static func hasSelection(_ surface: ghostty_surface_t) -> Bool {
    ...
    public static func selectionTopLeftPx(_ surface: ghostty_surface_t) -> (x: Double, y: Double)? {
    ...
    public static func readRegion(_ surface: ghostty_surface_t,
    ...
    public static func selectedText(_ surface: ghostty_surface_t) -> String? {
        var t = ghostty_text_s()
    ...
    @discardableResult
    public static func selectAll(_ surface: ghostty_surface_t) -> Bool {
    ...
    @discardableResult
    public static func bindingAction(_ name: String, on surface: ghostty_surface_t) -> Bool {
        name.withCString {
    ...
    @discardableResult
    public static func search(_ surface: ghostty_surface_t, needle: String) -> Bool {
    ...
    @discardableResult
    public static func navigateSearch(_ surface: ghostty_surface_t, forward: Bool) -> Bool {
    ...
    @discardableResult
    public static func endSearch(_ surface: ghostty_surface_t) -> Bool {
    ...
    public static func setPreedit(_ surface: ghostty_surface_t, _ text: String?) {
    ...
    public static func clear(_ surface: ghostty_surface_t, px: (x: Double, y: Double)?) {
    ...
    public static func insertText(_ surface: ghostty_surface_t, _ text: String) {
